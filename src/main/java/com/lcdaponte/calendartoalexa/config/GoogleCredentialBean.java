package com.lcdaponte.calendartoalexa.config;
...
@Configuration
public class GoogleCredentialBean {
    ...
    public Credential getCredentials() throws IOException, GeneralSecurityException {
        ...
        // Load client secrets.
        InputStream in = GoogleCredentialBean.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
